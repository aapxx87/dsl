...
Вот структурированное пояснение по типу `type` — с расширенными категориями и примерами. Это поможет лучше ориентироваться, когда пытаешься определить, **что именно делает понятие в мышлении** и как его **классифицировать**:
