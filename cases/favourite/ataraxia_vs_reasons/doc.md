...
Если нужно — можно дополнить профиль полями вроде `internal_loop` (порождает ли путь циклическое размышление?), `break_conditions` (когда путь может быть оставлен?), или `illusion_risk` (риск самообмана в мотивации).